...
<body>
	<div class="container-fluid">
		...
		%>
		<%
		String wrngmsg = (String) session.getAttribute("wrongmsg");
		if (wrngmsg != null) {
		%>

		<div class="alert alert-danger" role="alert"><%=wrngmsg%></div>
					...
					<div class="card mt-5 border border-dark">
						...
						<div class="card-body  p-3">
							...
							<div class="container text-center mt-2">
								...
								<a href="DeleteServlet?note_id=<%=po.getId() %>" class="btn btn-danger"><i
